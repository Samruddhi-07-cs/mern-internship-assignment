function OrderPanel({ cart, totalQuantity, isOpen, onToggle, onIncrease, onDecrease, onPlaceOrder }) {
  const total = cart.reduce((sum, item) => sum + item.price * item.quantity, 0)

  return (
    <>
      <button className="order-toggle" type="button" aria-expanded={isOpen} aria-controls="order-panel" onClick={onToggle}>
